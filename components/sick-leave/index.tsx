...
export function SickLeaveForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(URLS.SICK_LEAVE, {
        method: "POST",
      ...
      <CardContent className="w-full">
        <CardHeader className="pb-2 md:pb-4">
          ...
          <CardDescription className="text-sm md:text-base text-slate-600">
            Fill in the details below to submit your sick leave request. All
            fields are required.
          </CardDescription>
        </CardHeader>
        ...
        >
          ...
          <div className="space-y-2">
            <Label
              ...
              className="text-slate-700 flex items-center gap-1 text-xs md:text-sm font-medium"
            >
              <User className="w-3 h-3 md:w-4 md:h-4 text-slate-500" /> Employee
              Name *
            </Label>
            <Input
              id="employeeName"
              ...
              className="bg-white border-slate-300 text-slate-900 placeholder:text-slate-400 h-9 md:h-10 focus:border-purple-500 focus:ring-purple-500/20"
              required
            />
          </div>
          ...
          <div className="space-y-2">
            <Label
              ...
              className="text-slate-700 flex items-center gap-1 text-xs md:text-sm font-medium"
            >
              <Building2 className="w-3 h-3 md:w-4 md:h-4 text-slate-500" />{" "}
              Department *
            </Label>
            <Input
              id="department"
          ...
          <div className="space-y-2">
            <Label
              ...
              className="text-slate-700 flex items-center gap-1 text-xs md:text-sm font-medium"
            >
              <UserCheck className="w-3 h-3 md:w-4 md:h-4 text-slate-500" />{" "}
              Manager *
            </Label>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={today}
              className="bg-white border-slate-300 text-slate-900 h-9 md:h-10 focus:border-purple-500 focus:ring-purple-500/20"
              required
            />
          </div>
          ...
          <div className="space-y-2">
            <Label
              ...
              className="text-slate-700 flex items-center gap-1 text-xs md:text-sm font-medium"
            >
              <Calendar className="w-3 h-3 md:w-4 md:h-4 text-slate-500" /> End
              Date *
            </Label>
            <Input
              id="endDate"
          ...
          <div className="col-span-1 md:col-span-2 space-y-2">
            <Label
              ...
              className="text-slate-700 flex items-center gap-1 text-xs md:text-sm font-medium"
            >
              <FileText className="w-3 h-3 md:w-4 md:h-4 text-slate-500" />{" "}
              Reason *
            </Label>
            <Textarea
              id="reason"
              ...
              rows={2}
              className="bg-white border-slate-300 text-slate-900 placeholder:text-slate-400 focus:border-purple-500 focus:ring-purple-500/20 resize-none"
              required
            />
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            <Button
              type="submit"
              className="w-full h-10 md:h-12 text-sm md:text-lg font-semibold bg-purple-600 hover:bg-purple-500 text-white transition-all duration-200 shadow-lg shadow-purple-500/20"
