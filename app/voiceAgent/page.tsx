  ...
  return (
    <div className="h-dvh bg-white text-slate-900 font-sans overflow-hidden">
      ...
      <main className="container mx-auto px-3 sm:px-6 pt-16 sm:pt-20 pb-3 sm:pb-6 h-full">
        <div className="max-w-4xl mx-auto h-full flex flex-col gap-3 sm:gap-6">
          <div className="text-center shrink-0">
            <h2 className="text-lg sm:text-2xl font-bold text-foreground mb-2 sm:mb-4">
              Rumsan Voice Assistant
            </h2>
            <p className="text-xs sm:text-sm text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Experience our AI-powered voice assistant. Start a conversation to get help or explore our services through natural voice interaction.
            </p>
          </div>
          ...
          <div className="flex-1 min-h-0 px-0 sm:px-2">
            <VoiceAgent 
              ...
              description="Click the button below to start talking with our intelligent voice agent"
            />
          </div>
        </div>
      </main>
